...
namespace Api.DetVentas
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHttpClient("Ventas", config =>
            {
                config.BaseAddress = new Uri(Configuration["Services:Ventas"]);
            });
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Api.DetVentas", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Api.DetVentas v1"));
            }
